...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('RawByteTrafficModelling/PreTraining/PacketLevelAutoEncoder.log'),
...
MaskedLanguageModel.load_state_dict(torch.load("RawByteTrafficModelling/PreTraining/PacketLevelMLM.pth"))
...
AutoEncoderModel_path = "RawByteTrafficModelling/PreTraining/PacketLevelAutoEncoder.pth"
